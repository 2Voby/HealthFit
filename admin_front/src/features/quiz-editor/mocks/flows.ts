    ...
    questions: [
      {
        ...
        question: {
          ...
          requires: true,
          answers: [
            { id: 1, text: 'Weight loss', attributes: [3], created_at: ts, updated_at: ts },
            { id: 2, text: 'Build strength', attributes: [3, 6], created_at: ts, updated_at: ts },
            { id: 3, text: 'Flexibility', attributes: [3, 9], created_at: ts, updated_at: ts },
          ],
          created_at: ts,
          updated_at: ts,
        },
      },
      {
        ...
        question: {
          ...
          requires: false,
          answers: [
            { id: 4, text: 'At home', attributes: [4], created_at: ts, updated_at: ts },
            { id: 5, text: 'At the gym', attributes: [4], created_at: ts, updated_at: ts },
          ],
          created_at: ts,
          updated_at: ts,
        },
      },
      {
        ...
        question: {
          ...
          requires: true,
          answers: [
            { id: 6, text: '1-2 times', attributes: [6], created_at: ts, updated_at: ts },
            { id: 7, text: '3-4 times', attributes: [6], created_at: ts, updated_at: ts },
            { id: 8, text: '5+ times', attributes: [6], created_at: ts, updated_at: ts },
          ],
          created_at: ts,
          updated_at: ts,
        },
    ...
    questions: [
      {
        ...
        question: {
          ...
          requires: true,
          answers: [
            { id: 20, text: 'Beginner', attributes: [6], created_at: ts2, updated_at: ts2 },
            { id: 21, text: 'Intermediate', attributes: [6], created_at: ts2, updated_at: ts2 },
            { id: 22, text: 'Advanced', attributes: [6], created_at: ts2, updated_at: ts2 },
          ],
          created_at: ts2,
          updated_at: ts2,
        },
      },
      {
        ...
        question: {
          ...
          requires: false,
          answers: [
            { id: 23, text: 'Knee issues', attributes: [5], created_at: ts2, updated_at: ts2 },
            { id: 24, text: 'Back pain', attributes: [5], created_at: ts2, updated_at: ts2 },
            { id: 25, text: 'None', attributes: [], created_at: ts2, updated_at: ts2 },
          ],
          created_at: ts2,
          updated_at: ts2,
        },
    ...
    questions: [
      {
        ...
        question: {
          ...
          requires: true,
          answers: [
            { id: 40, text: 'Vegetarian', attributes: [8], created_at: ts2, updated_at: ts2 },
            { id: 41, text: 'Vegan', attributes: [8], created_at: ts2, updated_at: ts2 },
